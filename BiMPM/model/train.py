...
def get_args():
    ...
    parser.add_argument('--word_vector', type=str, default=join_path(data_dir, 'data/word_vec'),
                        help='path for pre-trained word vectors (e.g. Word2vec)')
    parser.add_argument('--train_data', type=str, default=join_path(data_dir, 'data/train.csv'),
                        help='training data path')
    parser.add_argument('--val_data', type=str, default=join_path(data_dir, 'data/test.csv'),
    ...
    parser.add_argument('--word_dim', type=int, default=64,
    ...
    for epoch in range(1, args.epochs + 1):
        for batch in train_iter:
            ...
            if steps % args.log_interval == 0:
                ...
                print(
                    'TRAIN[steps={}] loss={:.6f} acc={:.3f} P={:.3f} R={:.3f} F1={:.6f}'.format(steps, loss.item(), acc,
                                                                                                p, r, f1))
...
if __name__ == "__main__":
    ...
    args.char_vocab_size = len(dictionary)
