...
if __name__ == '__main__':
    dic = Dictionary(join_path(data_root_path,'data/atec_nlp_sim_train.csv'), join_path(data_root_path,'data/cha.vocab'), join_path(data_root_path,'data/word.vocab'))
    dataset = MyDataset(join_path(data_root_path,'data/atec_nlp_sim_train.csv'), 15, dic.word2idx)
    x1, x2, y = dataset[3]
    print(x1)
    print(y)