...
def get_args():
    ...
    parser.add_argument('--train_data', type=str, default=join_path(data_root_path,'data/train.csv'),
                        help='training data path')
    parser.add_argument('--val_data', type=str, default=join_path(data_root_path,'data/test.csv'),
...
if __name__ == '__main__':
    ...
    dictionary = Dictionary(join_path(data_root_path,'data/atec_nlp_sim_train.csv'))
