...
from .utils import Preprocessor, multilabel_categorical_crossentropy
from .GlobalPointer import DataMaker, MyDataset, GlobalPointer, MetricsCalculator
...
ent2id_path = os.path.join(
    config["data_home"], config["exp_name"], config["ent2id"])
...
def valid(model, dataloader):
    ...
    print("******************************************")
    print(
        f'avg_precision: {avg_precision}, avg_recall: {avg_recall}, avg_f1: {avg_f1}')
    print("******************************************")
    if config["logger"] == "wandb":
        logger.log({"valid_precision": avg_precision,
                   "valid_recall": avg_recall, "valid_f1": avg_f1})
    return avg_f1
