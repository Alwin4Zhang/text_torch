...
origindata_path = join_path(dirname(__file__),'origindata.txt')
...
def origin2tag():
    input_data = codecs.open(origindata_path,'r','utf-8')
...
def tagsplit():
    with open('wordtag.txt','r') as inp:
	    texts = inp.read()
    sentences = re.split('[，。！？、‘’“”（）]/[O]', texts)
    output_data = open('wordtagsplit.txt','w')
